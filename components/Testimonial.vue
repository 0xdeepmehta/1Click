<template>
    ...
    <div class="container px-5 py-24 mx-auto">
        ...
        <div class="p-4 md:w-1/2 w-full">
            ...
            <p class="leading-relaxed mb-6">I love this database tool. It is easy to handle and very powerful, especially for a small company such as mine. Since I started using it, we have noticed an increase in sales. I like that the program allows me to verify.</p>
